...
router.post('/dodaj-stranu', function (req, res) {
    ...
    var slug = req.body.slug.replace(/\s+/g, '-').toLowerCase(); //zamjeni prazan prostor za -
    if (slug == "")
    ...
    if (errors) {
        ...
        Page.findOne({slug: slug}, function (err, page) {
            if (page) { //ako ima stranica slug nije unikatan
            ...
            } else { //slug jeste unikatan
                var page = new Page({
                    title: title,
                    slug: slug,
                    content: content,
                    sorting: 100 //koja god je dodata bice zadnja
                });
                ...
                page.save(function (err) {
                    ...
                    req.flash('success', 'Stranica je dodata!'); //succes ime flasha
